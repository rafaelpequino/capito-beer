...
export default function Beer() {
    return (
        <section className="bg-[var(--black)] flex items-center justify-center px-4 py-16">
            <div className="w-full max-w-[1280px] text-[var(--white)] flex flex-col lg:flex-row gap-6 items-center">
                <div className="">
